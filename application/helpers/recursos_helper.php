...
function info_header_footer(){
	$CI = & get_instance();
	return $CI->core_model->get_by_id('sistema', array('sistema_id' => 1));
}

function grandes_marcas_navbar(){
	$CI = & get_instance();
	return  $CI->Loja_model->get_grandes_marcas();
}

function get_categorias_pai_navbar(){
	$CI = & get_instance();
	return  $CI->Loja_model->get_categorias_pai_navbar();
}

function get_categorias_filhas_navbar($categoria_pai_id = NULL){
	$CI = & get_instance();
	return  $CI->Loja_model->get_categorias_filhas_navbar($categoria_pai_id);
}
