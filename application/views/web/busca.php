	...
	<div class="container">
		<div class="breadcrumb-content">
			<ul>
				...
				<li class="active"><?php echo $palavra_digitada; ?></li>
			</ul>
		</div>
	</div>
</div>
								...
								<div class="row">
													...
													<div class="product_desc">
														...
														<div class="add-actions">
															<ul class="add-actions-link">
																<li class="add-cart active" style="text-align: center !important;"><a href="<?php echo base_url('produto/' . $produto->produto_meta_link) ?>">Visualizar</a></li>
															</ul>
														</div>
													</div>
												</div>
									...
									<?php else : ?>
										<div class="col-lg-12 text-center">
											<h5 class="mb_40">Não conseguimos encontrar o produto...</h5>
											<img width="30%" src="<?php echo base_url('public/web/images/not_found.svg') ?>" alt="<?php echo $palavra_digitada; ?>">
										</div>
										<h1></h1>
									<?php endif; ?>
