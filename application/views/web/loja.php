			...
			<div id="li-new-product" class="tab-pane active show" role="tabpanel">
				<div class="row">
					<div class="product-active owl-carousel">
						...
						<?php foreach ($produtos_destaque as $dest) : ?>

							<div class="col-lg-12">
								<!-- single-product-wrap start -->
								<div class="single-product-wrap">
									<div class="product-image">
										<a href="<?php echo base_url('produto/' . $dest->produto_meta_link) ?>">
											<img src="<?php echo base_url('uploads/produtos/' . $dest->foto_caminho) ?>" alt="<?php echo word_limiter($dest->produto_nome, 4) ?>">
										</a>
									...
									<div class="product_desc">
										<div class="product_desc_info">
											...
											<h4><a class="product_name" href="<?php echo base_url('produto/' . $dest->produto_meta_link) ?>"><?php echo word_limiter($dest->produto_nome, 4) ?> </a></h4>
											<div class="price-box">
												<span class="new-price"><?php echo 'R$&nbsp;' . number_format($dest->produto_valor, 2) ?></span>
											</div>
										</div>
										<div class="add-actions">
											<ul class="add-actions-link">
												<li class="add-cart active"><a href="<?php echo base_url('produto/' . $dest->produto_meta_link) ?>">Ver detalhes</a></li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="single-product-wrap">
								...
								<div class="product_desc">
									<div class="product_desc_info">
										...
										<h4><a class="product_name" href="single-product.html"><?php echo word_limiter($dest->produto_nome, 4) ?> </a></h4>
										<div class="price-box">
											<span class="new-price"><?php echo 'R$&nbsp;' . number_format($dest->produto_valor, 2) ?></span>
										</div>
									</div>
