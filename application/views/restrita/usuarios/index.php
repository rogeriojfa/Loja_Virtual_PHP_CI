                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-block">
                            ...
                            <a class="btn btn-primary float-right" href="<?php echo base_url('restrita/usuarios/core') ?>">+ Novo Usuário</a>
                        </div>
                        <div class="card-body">
                                        ...
                                        <?php foreach ($usuarios as $usuario): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url('restrita/usuarios/delete/' . $usuario->id); ?>" class="btn btn-danger btn-icon delete" data-confirm="Deseja Realmente excluir o registro?"><i class="fas fa-times"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach ?>
