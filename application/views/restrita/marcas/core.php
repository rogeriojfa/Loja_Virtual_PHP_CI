                ...
                <div class="col-12">
                    <div class="card">
                            ...
                            <div class="form-row">
                                ...
                                <?php if (isset($marca)): ?>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="marca_meta_link" class="form-control border-0"
                                               value="<?php echo $marca->marca_meta_link; ?>" readonly="">
                                <?php endif; ?>
                        ...
                        <div class="card-footer">
                            ...
                            <a class="btn btn-dark" href="<?php echo base_url('restrita/marcas'); ?>">Cancelar</a>
                        </div>
