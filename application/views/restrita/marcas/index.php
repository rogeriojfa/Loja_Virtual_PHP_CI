                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-block">
                            ...
                            <a class="btn btn-primary float-right" href="<?php echo base_url('restrita/marcas/core') ?>">+ Nova Marca</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php foreach ($marcas as $marca): ?>
                                            <tr>
                                                ...
                                                <td><?php echo ($marca->marca_ativa == 1 ? '<span class="badge badge-success">Ativa</span>' : '<span class="badge badge-danger">Inativa</span>' ) ?></td>

                                                <td>
                                                    <a href="<?php echo base_url('restrita/marcas/core/' . $marca->marca_id) ?>" class="btn btn-primary btn-icon"><i class="far fa-edit"></i></a>
                                                    <a href="<?php echo base_url('restrita/marcas/delete/' . $marca->marca_id); ?>" class="btn btn-danger btn-icon delete" data-confirm="Deseja Realmente excluir a marca?"><i class="fas fa-times"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach ?>
